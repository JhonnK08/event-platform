    ...
    if (!data) {
        return (
            <div className="flex flex-1 justify-center items-center">
                <div
                    className="spinner-border animate-spin inline-block w-10 h-10 border-4 rounded-full border-gray-200 border-t-transparent"
                    role="status"
                >
                    <span className="hidden">Carregando...</span>
                </div>
            </div>
        );
    }
